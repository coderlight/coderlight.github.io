...
function addMapper(callback) {
  ...
  for(i=0;i<themaps.length;i++) {
    ...
    canvas.className="mapper_element";
    ...
    bgrnd.className="mapper_element";
    bgrnd.left=0;
    bgrnd.top=0;
    ...
    blind.className="mapper_element";
    blind.left=0;
    blind.top=0;
...
removeMapper = function(callback) {
  callback = callback || _.noop;
  $(".mapper_element").remove();
  $("#map").css("opacity",1).addClass("mapper");
